...
class _CommentFieldState extends State<CommentField> {
  ...
  @override
  void initState() {
    controller = TextEditingController(text: context.read<NotesRepo>().comment);
    super.initState();
  }
      ...
      children: [
        BlurContainer(
          ...
          child: Column(
            ...
            children: [
              Text('Запись', style: context.s12w500.copyWith(color: colors_2)),
              SizedBox(height: 8.h),
              SizedBox(
                width: 307.w,
                child: TextField(
                  controller: controller,
                  onChanged: (value) => context.read<NotesRepo>().comment = value,
